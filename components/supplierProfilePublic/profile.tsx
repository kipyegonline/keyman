...
const supplierData: ISupplierInfo & {
  ...
  comments:
    "Leading construction materials supplier in East Africa with over 15 years of experience. We specialize in premium quality building materials, tools, and equipment for both residential and commercial projects.",
  rating: 4.8,
  yearsInBusiness: 15,
  totalProjects: 2500,
    ...
    <div className="w-full h-full bg-white">
      ...
      <div className="p-4 space-y-4 overflow-y-auto">
          ...
          <div className="flex items-start gap-2 mb-2">
            ...
            <div className="flex-1">
              ...
              <Button
                ...
                leftSection={<MapPin className="w-3 h-3" />}
        ...
        {supplier.categories.length > 0 && (
          <div>
            <Text size="sm" className="font-bold text-gray-900 mb-2">
              Categories
            </Text>
            <Chip.Group>
