"use client";
import { Container, Paper, Title, Text, Button, Stack, Card } from "@mantine/core";
        ...
        <Stack gap="lg" align="center">
          ...
          <div>
            ...
            <Text size="lg" c="dimmed" className="max-w-md mx-auto">
              Your wallet registration has been submitted successfully. You can now access your digital wallet and start making secure transactions.
            </Text>
          </div>
          ...
          <Card 
            ...
            radius="md"
          >
            <Text size="sm" fw={500} style={{ color: "#3D6B2C" }} className="mb-2">
              What's Next?
            </Text>
