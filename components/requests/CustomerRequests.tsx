...
const RequestsTable: React.FC<{ requests: RequestDelivery[] }> = ({requests}) => {
        ...
        <Group gap="xs">
          <Box
            ...
            style={{ 
              ...
              transform: hoveredRow === request.id ? 'scaleY(1.2)' : 'scaleY(1)'
            }}
          />
          <Box>
        ...
        <Group gap="xs">
          <Box
            ...
            style={{ 
              ...
              transform: hoveredRow === request.id ? 'rotate(5deg) scale(1.1)' : 'rotate(0deg) scale(1)'
            }}
          >
...
const RequestIndicators=(<Flex justify="space-between" align="center" mt="md" p="sm">
        <Text size="sm" c="dimmed">
          Showing {requests?.length} requests
        </Text>
        <Group gap="xs">
          <Box className="w-3 h-3 rounded-full" style={{ backgroundColor: '#3D6B2C' }} />
          <Text size="xs" c="dimmed">Active</Text>
          <Box className="w-3 h-3 rounded-full" style={{ backgroundColor: '#F08C23' }} />
          <Text size="xs" c="dimmed">Pending</Text>
          <Box className="w-3 h-3 rounded-full" style={{ backgroundColor: '#388E3C' }} />
    ...
    <Container size="xl" py="xl">
      ...
      <Box mb="xl">
        <Group gap="md" mb="md">
          ...
          />
          <Flex  direction={{base:"column",sm:"row"}} align="center" className=' w-full ' justify={"space-between"}>
      ...
      >{RequestIndicators}
        <Box
          ...
          style={{ background: 'linear-gradient(to right, #3D6B2C, #388E3C, #F08C23)' }}
        />
        ...
        <Table highlightOnHover className="table-auto">
          <Table.Thead>
            <Table.Tr className="bg-gradient-to-r from-gray-50 to-gray-100">
              ...
              <Table.Th className="font-semibold text-gray-700">Request Code</Table.Th>
              <Table.Th className="font-semibold text-gray-700">Created</Table.Th>
              <Table.Th className="font-semibold text-gray-700">Delivery Date</Table.Th>
              <Table.Th className="font-semibold text-gray-700">Created From</Table.Th>
              <Table.Th className="font-semibold text-gray-700 text-center">Quotes</Table.Th>
              <Table.Th className="font-semibold text-gray-700 text-center">Items</Table.Th>
              <Table.Th className="font-semibold text-gray-700">Status</Table.Th>
              <Table.Th className="font-semibold text-gray-700 text-center">Actions</Table.Th>
            </Table.Tr>
          </Table.Thead>
