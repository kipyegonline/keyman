...
const KeymanLogin: React.FC = () => {
  ...
  const form = useForm<LoginFormValues>({
    ...
    validate: {
      ...
      password: (value) =>
        value.trim().length < 5 ? "Password is required" : null,
    },
  });
  ...
  const handleSubmit = async (values: LoginFormValues) => {
    ...
    if (response.status) {
      ...
      notify.error(
        response?.message?.email?.[0] || "Invalid email or password",
        "Login Failed"
      );
    }
  };
        ...
        <div className="text-center mb-8">
          ...
          <Group gap={4} justify="center">
            ...
            <Link
              ...
              className="text-keyman-green font-medium hover:text-keyman-green-hover transition-colors duration-200"
            >
              CREATE ACCOUNT
            </Link>
          </Group>
          ...
          <div className="space-y-2">
            ...
            <div className="text-right">
              <Link
                ...
                className="text-keyman-green hover:text-keyman-green-hover transition-colors duration-200"
              >
